...
module.exports = function (session) {
  ...
  RedisStore.prototype.get = function (sid, fn) {
    ...
    store.client.get(psid, function (er, data) {
      ...
      if (store.serializer.parseAsync) {
        return store.serializer.parseAsync(data, fn);
      }
  ...
  RedisStore.prototype.set = function (sid, sess, fn) {
    ...
    function stringify(sess, callback) {
        if (store.serializer.stringifyAsync) {
          return store.serializer.stringifyAsync(sess, callback);
        }
        try {
    ...
    stringify(sess, function (err, jsess) {
        args.push(jsess);
